...
- ユーザーから見える endolphin 固有の変更: `CHANGELOG-endolphin.md` の `## Unreleased` を更新する。
  upstream 所有の `CHANGELOG.md` は手編集しない。手順は [changelog-update.md](references/tasks/changelog-update.md)
